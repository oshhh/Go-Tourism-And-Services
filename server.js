...
function planTrip(callback, trip) {
    ...
    runQuery(function(result) {
        ...
        flight_query = "select * from flight f1, service where f1.service_id = service.service_id and from_city = " + "\"Delhi\"" + " and to_city = " + "\"Mumbai\"" + " order by price * (1 - discount * 0.01) limit 1;"
        runQuery(function(result) {
            console.log(trip);
            if(result.length > 0) 
...
async function main() {
    ...
    planTrip(function(result) {console.log(result)}, {user_id : "\"USR00000\"", destination_city : "\"Delhi\"", number_of_people : 4, number_of_days : 2, budget : 10000000});
}
main();
